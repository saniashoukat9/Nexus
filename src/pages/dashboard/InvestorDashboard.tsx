    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-5 text-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm opacity-80">Investor Wallet Balance</p>
            <p className="text-3xl font-bold">$147,000</p>
            <p className="text-xs opacity-60 mt-0.5">Available for investments</p>
          </div>
        </div>
        <div className="flex gap-2 flex-wrap">
          <Link to="/payments">
            <button className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition">
              Manage Payments →
            </button>
          </Link>
          <Link to="/payments">
            <button className="bg-white text-blue-700 px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-opacity-90 transition">
              Fund a Deal 🤝
            </button>
          </Link>
        </div>
